...
else ifneq ($(CIPHER_BUILD),)
BOOTMGR_ANDROID_DISTRIBUTION_NAME := CipherOS $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)
BOOTMGR_ANDROID_OTA_PACKAGE_NAME := $(CIPHER_VERSION).zip
BOOTMGR_ARTIFACT_FILENAME_PREFIX := $(CIPHER_VERSION)
